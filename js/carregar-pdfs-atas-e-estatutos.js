document.addEventListener("DOMContentLoaded", () => {
  const arquivosAtasEstatuto = [
    ...
    { nome: "Ata de Aprovação de Contas de 2021,\n Alteração da Sede Social e Inclusão do 3º Membro do Conselho Fiscal \n06/04/2022", arquivo: "ATA-06-04-2022.pdf" },
    { nome: "Ata de Aprovação de Contas 2019 e 2020,\n Alteração da Sede Social e Alteração Parcial do Estatuto \n24/06/2021", arquivo: "ATA-24-06-2021.pdf" },
